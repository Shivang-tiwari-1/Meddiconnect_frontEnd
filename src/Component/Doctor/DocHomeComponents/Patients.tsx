...
import { scrollThrough, setscroll } from "../../../Redux/slices/Doctor.Redux";
    ...
    >
      <div className=" rounded-md w-full mx-2 h-[60vh] flex flex-col  ">
        ...
        <div className="flex justify-center items-center h-[40vh] ">
          {/***first elemnt start***/}
          <div
            className={`h-[40vh] tablet:w-[80%] desktop:w-[70%] flex  gap-5 p-5 rounded-lg ${
              patientData.length === 1 ? "justify-center " : ""
            } ${
          ...
          >
            {patientData.map(
              (patient: Record<string, unknown>, index: number) => {
                ...
                return (
                  <div
                    className={`flex flex-col justify-center items-center gap-6 transition-transform duration-300 ease-out  w-full ${
                      patientData.length > 2
                        ? IsInFocus
                  ...
                  >
                    <div
                      className={`flex justify-center items-center desktop:h-[20vh] desktop:w-[46vh] rounded-3xl px-2 border-2  ${
                        patientData?.length > 2
                          ? " h-[25vh] w-[46vh]"
                          : "h-[25vh] w-full"
                      }`}
                    >
                      ...
                      <div className="flex justify-center flex-col items-center w-full h-[24.5vh] gap-5">
                        ...
                        <p className="font-[500] text-sm">
                          Number:{" "}
                          {
                            patient.appointmentStatus[0]?.patient[0]
                              .patientnumber
                          }
                        </p>
                      </div>
