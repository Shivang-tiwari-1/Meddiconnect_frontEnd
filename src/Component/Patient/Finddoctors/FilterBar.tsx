        ...
        <div className="desktop:w-[15vw] phone:w-[15vw] px-[1rem] dark:bg-lightBlack dark:text-textWhite">
                ...
                <div className="py-2 border-b">
                    {locality.map((item) => (
                        ...
                        <div key={item} className="flex gap-2">
                            <input
                                type="checkbox"
                                className="cursor-pointer" onChange={handleCheckboxChange(item)} checked={selectedStates.includes(item)} />
                            <div>{item}</div>
                        </div>
                    ))}
                </div>
            ...
            <div className="pt-4">
                ...
                <div className="py-2 border-b">
                    {speacilist.map((item) => (
                        <div key={item} className="flex gap-2">
                            <input type="checkbox" className="cursor-pointer" onChange={handleCheckboxChange(item)} checked={selectedStates.includes(item)} />
                            <div>{item}</div>
                        </div>
                    ))}
                </div>
