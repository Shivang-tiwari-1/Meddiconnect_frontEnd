...
const Cards: React.FC<incomingdata> = ({
  ...
  return (
    <>
      {/* Document Card */}
      <div
        className={`border-2 h-[30vh] tablet:w-[30%] desktop:w-[20%] rounded-3xl shadow-2xl ${
          !show2 ? "hover:scale-105 transition-transform" : ""
        } ${qualificationExists ? "hidden" : ""}`}
      >
        {qualificationExists ? null : (
          <>
      ...
      <div
        className={`border-2 h-[30vh] tablet:w-[30%] desktop:w-[20%] rounded-3xl shadow-2xl ${
          !show3 ? "hover:scale-105 transition-transform" : ""
      ...
      <div
        className={`border-2 h-[30vh] tablet:w-[30%] desktop:w-[20%] rounded-3xl shadow-2xl ${
          !show4 ? "hover:scale-105 transition-transform" : ""
